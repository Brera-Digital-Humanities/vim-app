...
let outbox         = [];     // Completed forms to send
                             // Shape: [{answers, mediaFiles, savedAt, label}]
let sentForms      = [];     // Already-sent forms (metadata only)
let drafts         = [];     // Saved drafts
                             // Shape: [{answers, mediaFiles, pageIdx, fieldIdx, savedAt, label}]
                             // window._editingDraft = index of the draft being edited (null = new form)
